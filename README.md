<img src="https://img.shields.io/badge/version-1.0.1-black" />
...
|2023-01-25, 26|1. 체크 판별 버그 수정.<br>2. `customizable` 체스 완성.<br>3. 프로모션 버그 수정.<br>4. 프로젝트 명 변경.(chesses)|
|2023-03-18|1. 캐슬링 오류 수정.|

> 2023년 1월 26일 3시경 `chesses` 프로젝트 종료
